def is_pydantic(obj: object):
    """ Checks if an object is pydantic. """
    return type(obj).__class__.__name__ == "ModelMetaclass"


# There were some issues with nested objects & Pydantic Schemas & SQL Alchemy models.
# I added parser function here to map & parse data into SQLAlchemy schemas to avoid error:
